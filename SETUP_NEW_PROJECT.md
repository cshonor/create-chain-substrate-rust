...
根据 Polkadot SDK 2512.1 官方文档和依赖要求：
- **推荐版本**：Rust 1.88.0（满足所有依赖要求，包括 alloy-、revm-、time- 等需要 1.88.0 的包）
- **最低版本**：Rust 1.86.0（部分依赖可能不兼容，需要降级依赖版本）
- **特定开发任务**（如 Parachain Template）：Rust 1.86 或 1.88.0
